...
if __name__ == "__main__":
    ...
    model.eval()
    print("L351 model.eval()----------- ")
    first_dummy_pose = np.zeros([17,3])
    print("L349 fig = plt.figure( figsize=(9.6, 5.4))---------- ")
    fig = plt.figure( figsize=(9.6, 5.4))
    
    
    print("L351 fig = plt.figure( figsize=(9.6, 5.4))---------- ")
    ...
    gs.update(wspace=-0.00, hspace=0.05) 
    ax = plt.subplot(gs[0], projection='3d')
    print("L351 ax = plt.subplot(gs[0], projection='3d')----------- ")

    show3Dpose( first_dummy_pose, ax)
    print("L351 show3Dpose------------ ")

    # titles = ["1", "2," "3"]
    # values = [1, 2, 3]
    # ax2 = plt.barh(titles, values, color='skyblue')
    ...
    print("L351 Befor plt.show(block=False)----------- ")
